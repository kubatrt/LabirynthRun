		...
		for(int i = 0; i < ThisList.arraySize; i++)
		{
			...
			else
			{
				...
				for(int a = 0; a < MyArray.arraySize; a++){
					...
					MyArray.GetArrayElementAtIndex(a).intValue 
						= EditorGUILayout.IntField("",MyArray.GetArrayElementAtIndex(a).intValue, GUILayout.MaxWidth(100));
